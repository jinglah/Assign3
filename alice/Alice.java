...
class Alice {  // Alice is a TCP client
    ...
    public static final String BOB_PUBLIC_KEY_FILE = "bob.pub";
        ...
        public void readPublicKey() {
        	...
        	try {
                ObjectInputStream ois = 
                    new ObjectInputStream(new FileInputStream(BOB_PUB_KEY_FILE));
            ...
            System.out.println("Public key read from file " + BOB_PUB_KEY_FILE);
        }
